...
replacePJJQJJP={P1**O2n2[1]**Q1**O2n2[1]**P1->j5^2,
			...
			P1**O2n2[1]**Q1**O21[1]**P1->-I*j7^2*\[Sigma]1z,
			P2**O2n2[2]**Q2**O21[2]**P2->-I*j7^2*\[Sigma]2z,
			P3**O2n2[3]**Q3**O21[3]**P3->-I*j7^2*\[Sigma]3z,
			P4**O2n2[4]**Q4**O21[4]**P4->-I*j7^2*\[Sigma]4z,

			P1**O2n2[1]**Q1**O22[1]**P1->I*j5*j7*\[Sigma]1z,
			P2**O2n2[2]**Q2**O22[2]**P2->I*j5*j7*\[Sigma]2z,
			P3**O2n2[3]**Q3**O22[3]**P3->I*j5*j7*\[Sigma]3z,
			P4**O2n2[4]**Q4**O22[4]**P4->I*j5*j7*\[Sigma]4z,
